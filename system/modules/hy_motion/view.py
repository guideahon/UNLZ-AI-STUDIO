...
class HYMotionView(ctk.CTkFrame):
    def __init__(self, master, app, **kwargs):
        ...
        self.backend_dir = self.app_root / "system" / "ai-backends" / "HY-Motion-1.0"
    ...
    def build_ui(self):
        ...
        ctk.CTkLabel(log_frame, text=self.tr("hymotion_log_label")).grid(row=0, column=0, sticky="w", padx=10, pady=(10, 0))
    ...
    def install_backend(self):
        ...
        self.run_process(["git", "clone", "--depth", "1", "https://github.com/Tencent-Hunyuan/HY-Motion-1.0", str(self.backend_dir)])
        self.refresh_buttons()
